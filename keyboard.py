...
START_KEYBOARD = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton('Yapımcı', GITHUB_URL),
            InlineKeyboardButton('Reklam & İşbirliği', DEV_URL)   
        ]
    ]
)
...
CHILDMODE_BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("Aktif", callback_data='c_mode_1'),
            InlineKeyboardButton("Pasif", callback_data='c_mode_0')
        ]
    ]
)
...
AKI_PLAY_KEYBOARD = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton("Belki", callback_data='aki_play_3')
        ],
        [
            InlineKeyboardButton("Bilmiyorum", callback_data='aki_play_2'),
            InlineKeyboardButton("Emin değilim", callback_data='aki_play_4')
        ],
...
AKI_LEADERBOARD_KEYBOARD = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("Toplam Tahminler", callback_data='aki_lead_tguess'),
            InlineKeyboardButton("Doğru Tahminler", callback_data='aki_lead_cguess'),
        ],
        [
            InlineKeyboardButton("Yanlış Tahminler", callback_data='aki_lead_wguess'),
            InlineKeyboardButton("Toplam Sorular", callback_data='aki_lead_tquestions'),
        ]
    ]
)